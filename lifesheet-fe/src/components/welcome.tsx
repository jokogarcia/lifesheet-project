      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-16">
          <div>
            ...
            <p className="text-lg mb-4">
              LifeSheet helps you organize, update, and tailor your CV for different job
              applications, ensuring you always put your best foot forward.
            </p>
            <Button
              size="lg"
              onClick={() => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <Card>
            ...
            <CardContent>
              <p>
                Keep all your professional experience, education, and skills in one place. Never
                lose track of your achievements.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p>
                Adjust your CV for specific job applications. Highlight relevant experience and
          ...
          <Card>
            ...
            <CardContent>
              <p>
                Generate professional-looking CVs in multiple formats and share them directly with
                potential employers.
              </p>
            </CardContent>
          </Card>
